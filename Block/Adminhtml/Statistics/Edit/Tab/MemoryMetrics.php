...
class MemoryMetrics extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    /**
    ...
    */
    ...
    {
        $MemStat = $this->redis->generalStats("Memory");
        return $MemStat;
    }
